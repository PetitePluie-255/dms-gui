  ...
  return (
    <>
      <RBCard className={className} {...rest}>
        {(title || headerContent) && (
          <RBCard.Header className="bg-light bg-opacity-100">
            {title && (
              <RBCard.Title
                as="h5"
                className="mb-0 d-flex align-items-center w-100"
              >
                ...
                <div className="d-flex align-items-center">
                  ...
                  {isLoading && (
                    <span className="ms-2">
                      <LoadingSpinner isInline="true" size="sm" />
                    </span>
                  )}
                </div>
                ...
                <div className="d-flex align-items-center ms-auto gap-3">
                  ...
                  {(iconExtra || titleExtra) && (
                    <div className="d-flex align-items-center">
                      ...
                      {typeof titleExtra === 'string'
                        ? Translate(titleExtra, translate)
                        : titleExtra}
                    </div>
                  )}
        ...
        <Collapse in={open}>
          <RBCard.Body className={bodyClassName} id="collapsible">
            {children}
          </RBCard.Body>
        </Collapse>
      </RBCard>
